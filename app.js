document.addEventListener('DOMContentLoaded', () => {
    ...
    if (applicationForm) {
        applicationForm.addEventListener('submit', (e) => {
            ...
            submitBtn.innerHTML = 'Изпращане на кандидатурата... <svg class="icon-svg icon-spin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle; margin-left:4px;"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg>';
    ...
    if (reviewForm) {
        reviewForm.addEventListener('submit', (e) => {
            ...
            submitBtn.disabled = true;
            submitBtn.innerHTML = 'Изпращане... <svg class="icon-svg icon-spin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block; vertical-align:middle; margin-left:4px;"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg>';
    ...
    const chatFlow = {
        ...
        build: {
            text: "Строителството и грубият строеж са високобюджетни проекти с голяма печалба. Нашата система помага да филтрирате случайните хора и да достигнете до сериозни инвеститори. Готови ли сте да продължим?",
            options: [
                { text: "Да, готови сме", next: "complete_cta" },
                { text: "Искаме консултация първо", next: "complete_cta" }
            ]
        },
        solar: {
            text: "Соларните инсталации са изключително бързо развиващ се пазар с висок марж. За да си гарантирате постоянни запитвания за фотоволтаици, е важно да достигнете до собственици на къщи и производствени обекти. Имате ли готовност да поемете нови инсталации през следващия месец?",
            options: [
        ...
        complete_cta: {
            text: "Разбрахме. Изглежда, че нашата система е точно това, от което се нуждаете, за да се разрастнете. Ако и вие мислите така, можете да попълните нашата контактна форма сега, защото приемаме само по 2 бизнеса всеки месец",
            options: [
                { text: "Кандидатствай сега 🚀", action: "trigger_form" }
            ]
        }
    };
