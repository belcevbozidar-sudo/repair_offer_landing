document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatFlow = {
        ...
        complete_cta: {
            text: "Разбрахме. Изглежда, че нашата система е точно това, от което се нуждаете, за да напълните графика си. Ако и вие мислите така, можете да попълните нашата контактна форма сега, защото приемаме само по 2 бизнеса всеки месец",
            options: [
